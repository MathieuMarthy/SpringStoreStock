...
class CartController(
    ...
    @ApiResponses(value = [
        ApiResponse(responseCode = "200", description = "the deleted cart",
                content = [Content(mediaType = "application/json", schema = Schema(implementation = CartDTO::class))]),
        ApiResponse(responseCode = "404", description = "Cart not found",
                content = [Content(mediaType = "application/json")])
    ])
    ...
    @ApiResponses(value = [
        ...
        ApiResponse(responseCode = "404", description = "Cart not found",
                content = [Content(mediaType = "application/json")]),
        ApiResponse(responseCode = "409", description = "Item not enough stock",
                content = [Content(mediaType = "application/json")])
    ])
    ...
    @ApiResponses(value = [
        ApiResponse(responseCode = "200", description = "the valid cart",
                content = [Content(mediaType = "application/json", schema = Schema(implementation = CartDTO::class))]),
        ApiResponse(responseCode = "404", description = "Cart not found",
                content = [Content(mediaType = "application/json")]),
        ApiResponse(responseCode = "404", description = "Item not Found",
